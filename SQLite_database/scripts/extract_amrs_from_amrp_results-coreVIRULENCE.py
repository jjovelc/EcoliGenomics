...
FROM amrp_results
WHERE scope = 'core' AND element_type = 'VIRULENCE'
"""
...
pivot_df.to_csv('amrp_results_report-coreVIRULENCE.tsv', sep='\t', index=True)

print("\nPivot table saved to 'amrp_results_report-coreVIRULENCE.tsv'.")
