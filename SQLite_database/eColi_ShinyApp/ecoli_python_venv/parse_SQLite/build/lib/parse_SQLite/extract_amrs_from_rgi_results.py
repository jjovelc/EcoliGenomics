...
pivot_df = df.pivot_table(index='best_hit_ARO', columns='sample_id', aggfunc='size', fill_value=0)
...
pivot_df.to_csv('rgi_results_report.tsv', sep='\t', index=True)

print("\nPivot table saved to 'rgi_results_report.tsv'.")
