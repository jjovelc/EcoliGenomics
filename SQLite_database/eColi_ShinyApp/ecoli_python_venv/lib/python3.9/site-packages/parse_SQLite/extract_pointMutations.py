...
pivot_df = df.pivot_table(index='mutation', columns='sample_id', aggfunc='size', fill_value=0)
...
pivot_df.to_csv('pointMutation_results_report.tsv', sep='\t', index=True)

print("\nPivot table saved to 'pointMutation_results_report.tsv'.")
