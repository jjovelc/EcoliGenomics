...
pivot_df = df.pivot_table(index='name', columns='sample_id', aggfunc='size', fill_value=0)
...
pivot_df.to_csv('mge_results_report.tsv', sep='\t', index=True)

print("\nPivot table saved to 'mge_results_report.tsv'.")
